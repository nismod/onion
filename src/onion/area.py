...
def calculate(population, dwellings, radius_km,
    ...
    results = {
        ...
        'dwelling_density': {'value': round(dwelling_density), 'units': 'dwelling/km'},
        'energy_supply_elec_solar_pv': {'value': round(pv_potential, 2), 'units': 'kWh/year'},
        'energy_supply_heat_network_potential': {'value': round(heat_network_energy, 2), 'units': 'kWh/year'},
        'energy_supply_heat_pump_potential': {'value': round(heat_pump_demand, 2), 'units': 'kWh/annual'},
        'energy_supply_elec_other': {'value': round(energy_supply_shortfall_elec, 2), 'units': 'kWh/year'},
        'energy_supply_heat_other': {'value': round(energy_supply_shortfall_heat, 2), 'units': 'kWh/year'},
